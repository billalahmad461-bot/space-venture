...
Shield* Spaceship::getShield() const { 
    return _shield; 
}

Equipment* Spaceship::getEquipment() const { 
    return _equipment; 
}

Planet* Spaceship::getCurrentPlanet() const { 
    return _current_planet; 
}

Region* Spaceship::getRegion() const { 
    return _region; 
}
...
std::vector<Resource*> Spaceship::getCargo() const { 
    return _cargo; 
}

const std::vector<Crew*>& Spaceship::getCrew() const { 
    return _crew; 
}
...
const sf::Sprite& Spaceship::getSpriteTop() const { 
    return _sprite_top; 
}

const sf::Sprite& Spaceship::getSpriteMain() const { 
    return _sprite_main; 
}
...
void Spaceship::setRegion(Region* region) { 
    _region = region; 
}

void Spaceship::setCurrentPlanet(Planet* planet) { 
...
bool Spaceship::canUnlockRegion(Region* region) {
    return getEquipment()->getLvl() >= region->getDangerLevel();
}
